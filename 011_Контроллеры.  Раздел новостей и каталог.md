...
Обратие внимание на код контроллера - все эти setData, sendToView. Они повторяются. Если мы прямо сейчас приступим к товарам, то код будет скопирован в третий(!) раз. А мы не пишем одинаковый код дважды, если есть возможность что-то куда-то вынести и использовать.
