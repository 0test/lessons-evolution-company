...
Вы должны получить нечто подобное в админке

![1st area](assets/images/s80.png)

Теперь давайте это выведем в шаблоне. Тут всё мега-просто, используем уже знакомый documentObject и в нужным местах ставим ТВ.
...
В данном случае мы имеем три блока с текстом и фоновыми изображениями. Надо подразумевать, что блоков может быть как три, так и шесть или более -- что мешает заказчику добавить новую услугу? Значит, это мультиполе.

![1st area rdy](assets/images/s82.png)
...
![1st area rdy](assets/images/s83.png)
...
![services list](assets/images/s86.png)
...
![services list](assets/images/s87.png)
...
![services list](assets/images/s88.png)
...
Давайте теперь сделаем отправку формы на Evolution CMS