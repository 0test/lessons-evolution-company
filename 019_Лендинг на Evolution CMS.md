...
Блок с несколькими элементами. В каждом картинка, заголовок и текст. По сути, микс из слайдера и предыдущего примера.
...
```
Изображение для превью я взял более-менее подходящее. Вы можете нарисовать своё, кто ж вам запретит, сложить в любую папку и указать путь.
...
![pb переменные ](assets/images/s100-2.png) 
